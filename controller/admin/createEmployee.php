...
if (isset($_POST["btnSubmit"])) {
   ...
   $emp->createEmployee($user_id, $position, $nic, $mobile_number, $phone_number, $address, $emergency_contact_name, $emergency_contact_number, $date_joined, $qualification, $department, $profile_img);
                              ...
                              <?php if ($result) { ?>
                                 <form class="forms-sample padding_infor_info" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <input pattern="[0-9]{7}" placeholder="Eg. 2030000" title="Please enter valid Phone number Eg: 203XXXX" type="tel" class="form-control" name="emergency_contact_number" required></input>
                                    </div>
                                    ...
                                    <button type="button" class="btn btn-light" onclick="javascript:window.location='userCreationDashboard.php';">Cancel</button>
                                 </form>
                              <?php } ?>
                           </div>
                        </div>
