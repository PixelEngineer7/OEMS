<nav class="navbar navbar-expand-lg navbar-light">
    <div class="full">
        ...
        <div class="logo_section">
            <a href="../../view/employee/mainDashboard.php"><img class="img-responsive" src="../../assets/logo/logo_black.png" alt="#" /></a>
        </div>
                ...
                <ul class="user_profile_dd">
                    <li>
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="../../view/employee/myinformation.php">My Profile</a>
