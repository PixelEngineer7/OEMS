...
$dept = new employee();
$AE = $dept->countEmp($database);
foreach ($AE as $rowC)
    $countEmployee = (int)$rowC['total'];

$dept = new employee();
$RA = $dept->countSupervisor($database);
foreach ($RA as $rowD)
    $countSupervisor = (int)$rowD['total'];


$count1 = $countUser;
$count2 =  $countDepartment;
$count3 = $countEmployee;
$count4 = $countSupervisor;

$getTask = new task();
$getTask->count_task_emp_pending($user_id);

$countTsk1 = $getTask->count_task_pending();
$countTsk2 = $getTask->count_task_progress();
$countTsk3 = $getTask->count_task_OCOM();
$countTsk4 = $getTask->count_task_NCOM();

$pms_count1 = new pms();
$countPms1 = $pms_count1->count_plus_one();
$countPms2 = $pms_count1->count_plus_two();
$countPms3 = $pms_count1->count_pms_pendingHR();
$countPms4 = $pms_count1->count__pms_completed();
                                    ...
                                    <div class="full counter_section margin_bottom_30 red_bg">
                                        ...
                                        <div class="counter_no">
                                            <div>
                                                ...
                                                <p class="head_couter">Number of Supervisor</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
