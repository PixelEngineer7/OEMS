...
$result = mysqli_query($conn, "SELECT * FROM tbl_leave WHERE emp_id='$emp_id' ORDER BY leave_id ASC LIMIT $start_from, $limit");
...
$result_db = mysqli_query($conn, "SELECT COUNT(emp_id) FROM tbl_leave WHERE emp_id='$emp_id'");
if (!$result_db) {
    die('Error in SQL query: ' . mysqli_error($conn));
}
...
$getAll = $leave_bal->getEmpBalance($emp_id);
                            ...
                            <div class="col-md-12 margin_bottom_30">
                                <div class="row">
                                    <div class="col-md-3 mb-3">
                                        <div style=" box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                                            <div class="card-body">
                                                ...
                                                <p class="card-text">Create a Leave for Employee</p>
                                            </div>
                                                    ...
                                                    <div class="modal-dialog modal-lg" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <form method="post" action="../../controller/admin/create_leave_admin.php" id="leaveForm">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div style=" box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                                            <div class="card-body">
                                                <h5 class="card-title">Adjust Leave</h5>
                                                <p class="card-text">Adjust Leave balances for Employee</p>
                                            </div>
                                            <div class="card-footer">
                                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#adjustLeaveModal<?php echo $emp_id; ?>">
                                                    <i class="fa-solid fa-sliders"></i> Adjust
                                                </button>

                                                <!-- Create PMS Modal -->
                                                <div class="modal fade" id="adjustLeaveModal<?php echo $emp_id;   ?>" tabindex="-1" role="dialog" aria-labelledby="adjustLeaveModalLabel<?php echo $row['emp_id']; ?>" aria-hidden="true">
                                                    <div class="modal-dialog modal-sm" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="adjustModalLabel<?php echo $emp_id ?>">Adjust Leave balances for Employee </h5>
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                                            </div>
                                                            <div class="modal-body">
                                                                <form method="post" action="../../controller/admin/adjust_leave_bal.php">
                                                                    <!-- Populate form fields with current employee data -->
                                                                    <input type="hidden" name="emp_id" value="<?php echo $emp_id; ?>">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="col">
                                                                            ...
                                                                            <input type="number" name="wellness_leave" class="form-control" value="<?php echo $getAll[0]['bal_wellness']; ?>" min=0 max=5 required>
                                                                        </div>
                                                                        <div class="col">
                                                                            <label for="month">Vacation Leave Balance</label>
                                                                            <input type="number" name="vacation_leave" class="form-control" value="<?php echo $getAll[0]['bal_vacation']; ?>" min=0 max=90 required>
                                                                        </div>

                                                                        <div class="col">
                                                                            <label for="month">Sick Leave Balance</label>
                                                                            <input type="number" name="sick_leave" class="form-control" value="<?php echo $getAll[0]['bal_sick_leave']; ?>" min=0 max=22 required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="submit" class="btn btn-success" name="adjustLeaveBal">Save Changes</button>
                                                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                                    </div>
                                                                </form>
                                                            </div>
                            ...
                            <div class="white_shd full margin_bottom_30">
                                <div class="full graph_head">
                                    <div class="heading1 margin_0">
                                        <h2>Leaves History of Employee - <?php echo $empName . " " . $empSurname; ?></h2>
                                    </div>
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-sm" id="myTable">
                                            <thead>
                                                <tr>
                                                    <th># Leave No</th>
                                                    <th onclick="sortTable(1)" scope="col">Leave Type<i class="fa-solid fa-arrow-up-a-z"></i> </th>
                                                    <th>Start Date</th>
                                                    <th>End Date</th>
                                                    <th>Duration</th>
                                                    <th>Absence Phase</th>
                                                            ...
                                                            <div class="modal-dialog modal-md" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <form method="post" action="../../controller/admin/approve_leave_bal.php">
                                                                            <!-- Populate form fields with current employee data -->
...
<script>
    <?php
    if (isset($_SESSION['adjust'])) {
        unset($_SESSION['adjust']);
        echo '
        Swal.fire({
            icon: "success",
            title: "Operation Success!",
            text: "Employee Leave updated and adjusted where required from Balance!",
        }).then((result) => {
