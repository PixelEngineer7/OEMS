                           ...
                           <div class="col-md-4 mb-4">
                              <div style=" box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                                 <div class="card-body">
                                    ...
                                    <p class="card-text">Modify , Add Missing details or Assign to department</p>
                                 </div>
                                 <div class="card-footer text-center">
                                    ...
                                    <tbody>
                                       <?php while ($row = mysqli_fetch_array($result)) { ?>
                                          ...
                                          <tr>
                                             ...
                                             <td>
                                                <button type="button" class="btn-sm btn-warning" data-toggle="modal" data-target="#editModal<?php echo $row['user_id']; ?>">
                                                   <i class="fa-solid fa-gears fa-spin"></i> Update
                                                </button>
                                             </td>
                                             ...
                                             <!-- Add an "Edit" button that triggers the modal -->
                                             <td>
                                                <button type="button" class="btn-sm btn-info" data-toggle="modal" data-target="#changeModal<?php echo $row['user_id']; ?>">
                                                   <i class="fa fa-refresh" aria-hidden="true"></i> Change
                                                </button>
                                             </td>

                                             <!-- Edit Employee Modal -->
                                             <div class="modal fade" id="changeModal<?php echo $row['user_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="changeModalLabel<?php echo $row['user_id']; ?>" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                   <div class="modal-content">
                                                      <div class="modal-header">
                                                         <h5 class="modal-title" id="changeModalLabel<?php echo $row['user_id']; ?>">Change Employee Role</h5>
                                                         <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                            <span aria-hidden="true">&times;</span>
                                                         </button>
                                                      </div>
                                                      <div class="modal-body">
                                                         <!-- Form to edit employee details -->
                                                         <form method="post" action="../../controller/admin/change_category.php">
                                                            <!-- Populate form fields with current employee data -->
                                                            <input type="hidden" name="user_id" value="<?php echo $row['user_id']; ?>">

                                                            <div class="form-group">
                                                               <label for="user_access">Change Existing Employee Role to: </label>
                                                               <select class="form-control" name="category_user">
                                                            ...
                                                            <div class="modal-footer">
                                                               <button type="submit" class="btn btn-success" name="changeCat">Save Changes</button>
                                                               <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                                            </div>
   ...
   if (isset($_SESSION['updateCat'])) {
      ...
      echo '
        Swal.fire({
            ...
            text: "User Cateory Updated successfully!",
        }).then((result) => {
...
<script>
   <?php
   if (isset($_SESSION['createUserSuccess'])) {
