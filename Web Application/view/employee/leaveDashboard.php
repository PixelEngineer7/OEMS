                                                    ...
                                                    <div class="modal-dialog modal-lg" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <form method="post" action="../../controller/employee/create_leave_emp.php" id="leaveForm">
                                        ...
                                        <table class="table table-sm" id="myTable">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Start Date</th>
                                                    <th>End Date</th>
                                                    <th onclick="sortTable(0)" scope="col">Duration<i class="fa-solid fa-arrow-up-a-z"></i>
                                                    <th>Absence Phase</th>
                                                    <th>Leave Status</th>
                                                    <th>View Details</th>
