...
if (isset($_POST["addMetrics"])) {
    ...
    $pms = new pms();
    $pms->addMetricsSup($pms_id, $metric_array, $pms_status, $management_status);
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <?php $emp_id; ?><tr>
                                                        ...
                                                        <td style="text-align: center;"><input type="text" name="metric_array[]" required></td>
