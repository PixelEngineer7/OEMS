...
$countTsk1 = $getTask->count_task_emp_pending($user_id);
$countTsk2 = $getTask->count_task_emp_progress($user_id);
$countTsk3 = $getTask->count_task_emp_OCOM($user_id);
$countTsk4 = $getTask->count_task_emp_NCOM($user_id);


$pms_count1 = new pms();
$countPms1 = $pms_count1->count_pms_emp_sup_active($user_id);
$countPms2 = $pms_count1->count_pms_emp_sup_plus2($user_id);
$countPms3 = $pms_count1->count_pms_emp_n_2($emp_id);
$countPms4 = $pms_count1->count_pms_emp_sup_completed($user_id);
                            ...
                            <div class="row column1">
                                <div class="col-md-6 col-lg-3">
                                    <div class="full counter_section margin_bottom_30 red_bg">
                                        ...
                                        <div class="counter_no">
                                            <div>
                                                <p class="total_no"><?php if ($count1 < 0)
                                                                        echo "0";
                                                                    else {
                                                                        echo $count1;
                                                                    } ?></p>
                                ...
                                <div class="col-md-6 col-lg-3">
                                    <div class="full counter_section margin_bottom_30 yellow_bg">
                                        ...
                                        <div class="counter_no">
                                            <div>
                                                <p class="total_no"><?php if ($count2 < 0)
                                                                        echo "0";
                                                                    else {
                                                                        echo $count2;
                                                                    } ?></p>
                                ...
                                <div class="col-md-6 col-lg-3">
                                    <div class="full counter_section margin_bottom_30 brown_bg">
                                        ...
                                        <div class="counter_no">
                                            <div>
                                                <p class="total_no"><?php if ($count3 < 0)
                                                                        echo "0";
                                                                    else {
                                                                        echo $count3;
                                                                    } ?></p>
